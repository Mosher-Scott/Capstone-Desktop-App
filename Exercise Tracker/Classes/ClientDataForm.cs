...
namespace Exercise_Tracker.Classes
{
    class ClientDataForm
    {
        ...
        public static void GetAllClients()
        {
            ...
            try
            {
                ...
                using (SqlCommand command = new SqlCommand(query, connection))
                {
                    ...
                    {
                        var list = new List<ClientDataForm>();
                        while (reader.Read())
                            ClientDataForm.clients.Add(reader.GetInt32(0), $"{reader.GetString(1)} {reader.GetString(2)}");
        ...
        ///
        public static void GetAllMuscleGroups()
        {
            var query = "";
            ...
            try
            {
                ...
                using (SqlCommand command = new SqlCommand(query, connection))
                {
                    ...
                    using (var reader = command.ExecuteReader())
                    {
                        ...
                        while (reader.Read())
                            ClientDataForm.muscleGroups.Add(reader.GetInt32(0), $"{reader.GetString(1)}");
                    }
                }
            }
            catch (Exception ex)
